...
local function CanComplainChat(playerLocation)
...
FriendsMenuXP_Buttons["REPORT_SPAM"] = {
    ...
    show = function(name, dropdown) return dropdown.playerLocation and CanComplainChat(dropdown.playerLocation) end,
}
...
FriendsMenuXP_Buttons["REPORT_BAD_NAME"] = {
    ...
    func = function(name, dropdownFrame)
		PlayerReportFrame:InitiateReport(PLAYER_REPORT_TYPE_BAD_PLAYER_NAME, dropdownFrame.name, dropdownFrame.playerLocation)
    end,
    show = function(name, dropdown) return dropdown.playerLocation and CanComplainChat(dropdown.playerLocation) end,
}
