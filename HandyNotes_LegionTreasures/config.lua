...
if GetLocale() == 'zhCN' then
	L["World Map"] = '世界地图'
	L["Show icons on world map"] = '显示图标在世界地图'
	L["Minimap"] = '小地图'
	L["Show icons on the minimap"]= '显示图标在小地图'
	L["Show treasure"] = '显示宝藏'
	L["Show treasure that can be looted"] = '显示能被拾取的宝藏'
	L["Junk"] = '垃圾'
	L["Show items which don't count for any achievement"] = '显示不计入成就的物品'
...
elseif GetLocale() == 'zhTW' then
	L["World Map"] = '世界地圖'
	L["Show icons on world map"] = '顯示圖示在世界地圖'
	L["Minimap"] = '小地圖'
	L["Show icons on the minimap"]= '顯示圖示在小地圖'
	L["Show treasure"] = '顯示寶藏'
	L["Show treasure that can be looted"] = '顯示能被拾取的寶藏'
	L["Junk"] = '垃圾'
	L["Show items which don't count for any achievement"] = '顯示不計入成就的物品'
	...
	L["Show icons on world map"] = 'Show icons on world map'
	L["Minimap"] = 'Minimap'
	L["Show icons on the minimap"]= 'Show icons on the minimap'
